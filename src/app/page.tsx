      ...
      <div className="text-center space-y-8 max-w-lg z-10">
        ...
        <div className="pt-4">
          <SignInButton mode="modal">
            <Button
              size="lg"
              className="h-12 px-8 bg-primary hover:bg-primary/90 text-white font-semibold rounded-full shadow-[0_0_20px_-5px_rgba(146,128,252,0.5)] transition-all hover:scale-105"
            >
              Initialize Session
            </Button>
          </SignInButton>
