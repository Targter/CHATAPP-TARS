...
export function MessageInput({
  ...
  if (isBlocker) {
    return (
      <div className="p-4 pt-2 bg-transparent">
        <div className="flex items-center justify-center p-4 bg-card/80 backdrop-blur-lg rounded-2xl border border-border/50 text-sm text-muted-foreground shadow-sm">
  ...
  if (isBlocked) {
    return (
      <div className="p-4 pt-2 bg-transparent">
        <div className="flex items-center justify-center p-4 bg-destructive/10 backdrop-blur-lg rounded-2xl border border-destructive/20 text-sm text-destructive shadow-sm font-medium">
